...
import com.civil.aviation.human.api.office.request.CreateOfficeRequest;
import com.civil.aviation.human.api.office.request.DelOfficeRequest;
import com.civil.aviation.human.api.office.request.ModifyOfficeRequest;
import com.civil.aviation.human.api.office.request.QryOfficeByIdRequest;
...
public class OfficeApiImpl implements OfficeApi
{
	...
	@Override
	public QryOfficeByIdResponse findById (HttpServletRequest request, QryOfficeByIdRequest qryOfficeByIdRequest)
			throws Exception
	{
	...
	@Override
	public QryOfficeResponse queryConditionPage (HttpServletRequest request, HttpServletResponse response)
			throws Exception
	{
		QryOfficeResponse qryOfficeResponse = new QryOfficeResponse ();
		Map<String, Object> params = Maps.newHashMap ();

		if (! StringUtils.isEmpty (request.getParameter ("deparmentId")))
		{
			params.put ("department", request.getParameter ("deparmentId"));
		}

		if (! StringUtils.isEmpty (request.getParameter ("officeName")))
		{
			params.put ("name", request.getParameter ("officeName"));
		}
