...
@Getter
@Setter
public class QryRankConditionRequest extends BasePageRequest
{
	...
	{
		final StringBuilder sb = new StringBuilder ("QryRankConditionRequest{");
